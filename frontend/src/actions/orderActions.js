...
import {
    ...
    ORDER_PAY_SUCCESS, ORDER_PAY_FAIL, MY_ORDER_LIST_REQUEST,
    MY_ORDER_LIST_SUCCESS, MY_ORDER_LIST_FAIL, ORDER_DELETE_REQUEST,
...
const listMyOrders = () => async (dispatch, getState) => {
    try {
        ...
        dispatch({ type: MY_ORDER_LIST_FAIL, payload: error.response.data });
    }
}
